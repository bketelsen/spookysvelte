...
<script>
  ...
  import briandark from "./brian-dark.svg";
...
>
  <div class="flex flex-col text-xl text-neutral-content">
    ...
    <NavLinks label={nav.label} url={nav.url}/>
    {/each}
  </div>
</aside>
<div class="flex h-screen flex-col justify-between">
  <nav class="navbar bg-neutral text-neutral-content">
    ...
    <div class="items-center flex-1">
      <div class="px-2 pb-2 mx-2 flex-0">
        <a class="text-3xl font-bold text-primary" href="/">
          <img class="w-30 h-10" src={briandark} alt="brian ketelsen"/>
        </a>
      </div>
  ...
  >
    <div class="grid grid-flow-col gap-4">
      {#each settings.secondary_navigation as nav}
      <NavLinks label={nav.label} url={nav.url}/>
      {/each}
    </div>
    <div>
      <div class="grid grid-flow-col gap-4">
        <a href="https://twitter.com/bketelsen"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          ></a
        >
        <a href="https://youtube.com/bketelsen"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          ></a
        >
        <a href="https://facebook.com/bketelsen"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    <div>
      <p>Copyright © 2022 - All right reserved by Brian Ketelsen</p>
    </div>
  </footer>
</div>
